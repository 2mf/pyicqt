...
from pyicqt.tlib.ifcompat import Interface, implements
...
class XMPPChecker(object):
    ...
    def login(self, username, password):
        ...
        self.jfactory.addBootstrap(
            "//event/client/basicauth/invaliduser", self.authe)
        self.jfactory.addBootstrap(
            "//event/client/basicauth/authfailed", self.authe)
