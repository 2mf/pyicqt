...
# English - James Bunton <mailto:james@delx.cjb.net>/Daniel Henninger
# <mailto:jadestorm@nc.rr.com>
class en:
    # Text that may get sent to the user. Useful for translations. Keep any %s
    # symbols you see or you will have troubles later
    ...
    offline_messages_sendenc_local = u"Single-byte encoding"
    offline_messages_sendenc_auto = u"Auto"
