...
webport = 0
secret = "secret"
websecret = DeprecatedVariable(
    "websecret is no longer used as web interface auths against JID now.")
lang = "en"
encoding = "iso-8859-1"
...
useJ2Component = DeprecatedVariable(
    "useJ2Component has been split up into useComponentBinding and useRouteWrap.")
saslUsername = ""
avatarsOnlyOnChat = bool(False)
disableDefaultAvatar = bool(False)
disableAvatars = bool(False)
enableWebPresence = bool(False)
disableWebPresence = DeprecatedVariable(
    "disableWebPresence is now the default; use enableWebPresence to re-enable this functionality.")
