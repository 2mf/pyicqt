...
class AvatarCache:
    ...
    def dir(self, key):
        ...
        X = os.path.sep
        d = os.path.abspath(config.spooldir) + X + \
            config.jid + X + "avatars" + X + key[0:3] + X
    ...
    def setAvatar(self, imageData):
        ...
        try:
            ...
            LogEvent(WARN, msg="IOError writing to avatar %r - %r" %
                     (key, str(e)))
        os.umask(prev_umask)
        return avatar
    ...
    def getAvatarData(self, key):
        ...
        try:
            ...
            LogEvent(INFO, msg="IOError reading avatar %r - %r" %
                     (key, str(e)))
