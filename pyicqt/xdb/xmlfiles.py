...
XDBNS_CSETTINGS = XDBNS_PREFIX + "csettings"
...
class XDB:
    ...
    def set(self, file, xdbns, element):
        ...
        try:
            ...
            LogEvent(INFO, msg="XDB error writing entry %s to file %s" %
                     (xdbns, file))
            raise
    ...
    def getCSetting(self, jabberID, variable):
        ...
        # TODO: may be merge with getSetting? It more safe way for storing in
        # XML as I think
    ...
    def setCSetting(self, jabberID, variable, value):
        ...
        # TODO: may be merge with setSetting? It more safe way for storing in
        # XML as I think
...
def doHashDirUpgrade():
    ...
    # Do avatars...
    pre = os.path.join(
        os.path.abspath(config.spooldir), config.jid) + X + "avatars" + X
