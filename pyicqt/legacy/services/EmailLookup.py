...
class EmailLookup:
    ...
    def __init__(self, pytrans):
        ...
        self.pytrans.adhoc.addCommand(
            "emaillookup", self.incomingIq, "command_EmailLookup", rights_user)
    ...
    def incomingIq(self, el):
        ...
        if not self.pytrans.sessions.has_key(toj.userhost()) or not hasattr(self.pytrans.sessions[toj.userhost()].legacycon, "bos"):
            self.pytrans.adhoc.sendError("emaillookup", el, errormsg=lang.get(
    ...
    def sendForm(self, el, sessionid=None, errormsg=None):
        ...
        email.attributes["label"] = lang.get(
            "command_EmailLookup_Email", ulang)
    ...
    def lookupEmail(self, el, email, sessionid=None):
        ...
        self.pytrans.sessions[toj.userhost()].legacycon.bos.lookupEmail(
            email).addCallback(self.emailLookupResults, el, sessionid)
