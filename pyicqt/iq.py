...
class IqHandler:
    ...
    def __init__(self, pytrans):
        ...
        # A dict indexed by namespace prefix of handlers to fire given a
        # starts-with match
        self.prefixhandlers = {}
        # A dict indexed by namespace of handlers to fire given a particular
        # namespace
        self.handlers = {}
    ...
    def onIq(self, el):
        ...
        if not (iqType == "get" or iqType == "set"):
        ...
        for query in el.elements():
            ...
            self.sendIqError(to=fro, fro=to, ID=ID, xmlns=xmlns,
                             etype="cancel", condition="feature-not-implemented")
